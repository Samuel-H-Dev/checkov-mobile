        ...
        <Box safeArea px={2} py={8} w="90%" maxW={290}>
            ...
            <VStack space={3} mt={5} >
                <FormControl isRequired>
                    ...
                    <Input onChange={setEmail} size="lg" color="coolGray.200" keyboardType="email-address" placeholder="example@email.com" />
                </FormControl>

                <FormControl isRequired>
                    <FormControl.Label color="coolGray.300">Password</FormControl.Label>
                    <Input onChange={setPassword} size="lg" color="coolGray.200" type="password" />
                </FormControl>
